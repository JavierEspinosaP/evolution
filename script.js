...
(function() {
    var canvas = document.getElementById('canvas'),
        ...
        disturbanceAmount = 8; // Ajusta la intensidad aquí

    canvas.width = width;
    canvas.height = height;

    // Dibujar la textura inicial
    ...
    function displayState(ctx) {
        ...
        food.forEach(f => {
            ...
            ctx.beginPath();
            ctx.arc(f.pos.x, f.pos.y, 5, 0, 2 * Math.PI);
            ctx.fill();
