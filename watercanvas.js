 ...
 */
 WaterCanvas = function(width, height, documentElement, waterModel, props) {
    ...
    // Check if a canvas already exists in the documentElement
    this.canvas = this.documentElement.querySelector('canvas') || document.createElement('canvas');
    ...
    if (!this.documentElement.querySelector('canvas')) {
