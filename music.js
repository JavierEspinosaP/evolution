document.addEventListener("DOMContentLoaded", function() {
    ...
    let gainNode;
    let bufferSource;
    const fadeInDuration = 5;  // Duración del fade in en segundos
    ...
    const randomPads = ['pad1.wav', 'pad2.wav', 'pad3.wav','pad4.wav', 'pad5.wav', 'pad6.wav'];
    ...
    function playLoopingAudio(buffer) {
        ...
        gainNode.gain.linearRampToValueAtTime(volumeMax, audioContext.currentTime + fadeInDuration);
